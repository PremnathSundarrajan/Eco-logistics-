  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "Missing required fields: pickupLocation, deliveryLocation, cargoType, cargoWeight, cargoVolumeLtrs",
      });
    }
...
const getUnassignedDeliveries = async (req, res) => {
  try {
    ...
    const whereClause = {
      ...
      OR: [{ courierCompanyId: courierCompanyId }, { courierCompanyId: null }],
    };
